...
public class Hero {
        ...
        g = builder.g;
        b = builder.b;
        //adding to reneder a model of hero
        Block m = new NormalHero();
        
        CurrentHeroPositions currenthermypos = new CurrentHeroPositions((NormalHero) m);
        
        m.make(drawable,p11,p12,p13,r,g,b);
